...
import { Plane, Home, Award } from 'lucide-react';

const serviceIcons = [Plane, Home, Award];

export function GlobalIdentitySection() {
  const t = useTranslations('globalIdentity');
  const services = t.raw('services') as Array<{ title: string; description: string }>;

  return (
    <section id="global-identity" className="section-padding bg-background scroll-mt-20 md:scroll-mt-24 snap-section flex flex-col justify-center min-h-fit">
  ...
  return (
    ...
    >
      <CardContent className="p-4 sm:p-5">
        {/* Icon */}
        <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-[var(--radius-md)] bg-gradient-to-br from-secondary to-accent
